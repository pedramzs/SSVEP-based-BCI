...
function [ ] = FlickersON( wPtr, j, square1, square2, square3, square4, square5, square6, square7, square8, square9, square10, Circle, color1, ...
    line1, line2, Width, Height, text1_1, text2_1, text3_1, text4_1, text5_1, text6_1, text7_1, text8_1, text9_1, text10_1 )
% this function plots frequently changing squeres and circle


% draw flickers
Screen('FillRect',wPtr,[255/2*(1+sin(2*pi*5*j/60)) 255/2*(1+sin(2*pi*5*j/60)) 255/2*(1+sin(2*pi*5*j/60))],square1);
Screen('FillRect',wPtr,[255/2*(1+sin(2*pi*6*j/60)) 255/2*(1+sin(2*pi*6*j/60)) 255/2*(1+sin(2*pi*6*j/60))],square2);
Screen('FillRect',wPtr,[255/2*(1+sin(2*pi*7*j/60)) 255/2*(1+sin(2*pi*7*j/60)) 255/2*(1+sin(2*pi*7*j/60))],square3);
Screen('FillRect',wPtr,[255/2*(1+sin(2*pi*8*j/60)) 255/2*(1+sin(2*pi*8*j/60)) 255/2*(1+sin(2*pi*8*j/60))],square4);
Screen('FillRect',wPtr,[255/2*(1+sin(2*pi*9*j/60)) 255/2*(1+sin(2*pi*9*j/60)) 255/2*(1+sin(2*pi*9*j/60))],square5);
Screen('FillRect',wPtr,[255/2*(1+sin(2*pi*13*j/60)) 255/2*(1+sin(2*pi*13*j/60)) 255/2*(1+sin(2*pi*13*j/60))],square6);
Screen('FillRect',wPtr,[255/2*(1+sin(2*pi*15*j/60)) 255/2*(1+sin(2*pi*15*j/60)) 255/2*(1+sin(2*pi*15*j/60))],square7);
Screen('FillRect',wPtr,[255/2*(1+sin(2*pi*17*j/60)) 255/2*(1+sin(2*pi*17*j/60)) 255/2*(1+sin(2*pi*17*j/60))],square8);
Screen('FillRect',wPtr,[255/2*(1+sin(2*pi*19*j/60)) 255/2*(1+sin(2*pi*19*j/60)) 255/2*(1+sin(2*pi*19*j/60))],square9);
Screen('FillRect',wPtr,[255/2*(1+sin(2*pi*20*j/60)) 255/2*(1+sin(2*pi*20*j/60)) 255/2*(1+sin(2*pi*20*j/60))],square10);
